...
class CreatePermissoesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('permissoes', function (Blueprint $table) {
            $table->id();
            $table->string('permissao_tipo')->nullable();
            $table->string('permissao_justificativa')->nullable();
            $table->string('permissao_permitido_em')->nullable();
            $table->unsignedBigInteger('permissao_legislacao_id')->nullable();
            ...
            $table->integer('permissao_status');
            $table->timestamps();
        });
    }
